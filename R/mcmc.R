...
run_MCMC <- function(parTab,
    ...
    #   ## parTab, save_chain, adaptive_period, adaptive_period,adaptive_period_init,
    #   ## adaptiveLeeway, chain_colnames,chain_index,CREATE_POSTERIOR_FUNC,
    #   ## current_pars,data,filename,fixed,i,iterations,lower_bounds,
    #   ## max_adaptive_period,mcmc_chain_file,mcmcPars,misc,misc_colnames,misc_length,
    #   ## mvrPars,no_recorded,op_freq,OPT_TUNING,p_accept_adaptive,par_i,par_names,
    #   ## parallel_tempering_iter,param_length,pcurUnifxed,popt,poptRange,
    #   ## posterior_out,probab,reset,sampno,save_block,steps,tempaccepted,
    #   ## temperature,tempiter,thin,TUNING_ERROR,unfixed_par_length,unfixed_pars,upper_bounds,
    #   ## posterior_simp,PRIOR_FUNC
    #   
    ...
    #             }
    #         }
    #         f <- create_run_MCMC_single_iter_fn(unfixed_pars,unfixed_par_length,
    #                                             lower_bounds,upper_bounds,steps,scale,
    #                                             covMat,mvrPars)
    #         chain_index <- chain_index + 1
    #     }
    #   # the variables which are changed are current_pars, probab, misc, 
    #   # tempaccepted,save_chain,no_recorded,opt_chain,chain_index,
    #   # pcur, steps, covMat, tempiter, scale
    ...
    #     i <- i + 1
    # }
    # ### the while loop goes all the way down to here... argh
    # 
